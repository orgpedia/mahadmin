...
import/websites/gr.maharashtra.gov.in/Admin:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Admin .
...
import: check_env import/websites/gr.maharashtra.gov.in/Admin .secrets/google.token import/models/ai4bharat/IndicTrans2-en/ct2_int8_model
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Admin import/documents
