# Orders of deparment of General Administration Department Government of Maharashtra

This is a data package repository that process orders obtained from department of General Administration Department Government of Maharasthra. The data is obtained by processing orders from Government of Maharashtra's [Orders Website](https://gr.maharashtra.gov.in/1145/Government-Resolutions) website.
...
1. [mahadmin-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahadmin-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
## Data Details
- **First Order:** [201803161224022707.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/201803161224022707.pdf) (16 March 2018)
- **Last Order:** [202309011756530207.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/202309011756530207.pdf) (01 September 2023)
- **Last Crawl Date:** 02-Sep-2023
- **Total Orders:** 3817
- **Translated Orders:** 3798
...
```
git clone https://github.com/orgpedia/mahadmin.git
```
